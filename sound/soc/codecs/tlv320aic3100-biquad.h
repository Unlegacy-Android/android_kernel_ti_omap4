 ...
 *						        21-Jul-2010
 * Rev 0.3      Added the aic31xx_parse_data struct
 *                                                      29-Jul-2010
 */

#ifndef _TLV320AIC31xx_BIQUAD_H
#define _TLV320AIC31xx_BIQUAD_H
...
/*******************************************************************************
 * AIC31xx Equalizer related defines and structs
 ******************************************************************************/
#define AIC31xx_SPK_EQ_SELECT		0
#define AIC31xx_HP_EQ_SELECT		1
...
/* @struct aic31xx_parse_data - . Parser info structure
 *
 * Structure used to parse through the EQ Array defined in the
 * tlv320aic31xx_eq_coeff.h This structure will be initialized
