...
/*#define AIC31xx_GPIO_INTR_SUPPORT*/
#undef AIC31xx_GPIO_INTR_SUPPORT
...
extern void aic31xx_add_biquads_controls(struct snd_soc_codec *codec);
extern int aic31xx_add_EQ_mixer_controls(struct snd_soc_codec *codec);
extern int aic31xx_parse_biquad_array(struct snd_soc_codec *codec);
extern int aic31xx_update_biquad_array(struct snd_soc_codec *codec,
				int speaker_active, int playback_active);
#endif

int aic31xx_headset_speaker_path(struct snd_soc_codec *, int);
