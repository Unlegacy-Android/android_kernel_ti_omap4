...
#define OMAP4430_VDD_MPU_OPPNITROSB_UV		1335000 /* 1385000 */
#define OMAP4430_VDD_MPU_OPPNITROSB2_UV		1350000 /* 1400000 */
#define OMAP4430_VDD_MPU_OPPSUPERSB_UV		1360000 /* 1410000 */
#define OMAP4430_VDD_MPU_OPPSUPERSB2_UV		1365000 /* 1415000 */
#else
...
struct omap_volt_data omap443x_vdd_mpu_volt_data[] = {
...
#ifdef CONFIG_OMAP4430_CPU_OVERCLOCK
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITRO2_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITRO, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
	...
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPSUPERSB_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPSUPERSB, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPSUPERSB2_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPSUPERSB, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
#else
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITROSB_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSB, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
#endif
...
static struct omap_vdd_dep_volt omap443x_vdd_mpu_core_dep_data[] = {
	...
	{.main_vdd_volt = OMAP4430_VDD_MPU_OPPSUPERSB_UV, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP100_OV_UV},
	{.main_vdd_volt = OMAP4430_VDD_MPU_OPPSUPERSB2_UV, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP100_OV_UV},
#else
	{.main_vdd_volt = OMAP4430_VDD_MPU_OPPNITROSB_UV, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP100_UV},
#endif
};
...
#ifdef CONFIG_OMAP4430_CPU_OVERCLOCK
	/* MPU OPP4 - OPP-NITRO2 */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", false, 1200000000, OMAP4430_VDD_MPU_OPPNITRO2_UV),
	/* MPU OPP5 - OPP-NITROSB */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", false, 1350000000, OMAP4430_VDD_MPU_OPPNITROSB_UV),
	/* MPU OPP6 - OPP-NITROSB2 */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", false, 1420000000, OMAP4430_VDD_MPU_OPPNITROSB2_UV),
	/* MPU OPP7 - OPP-SUPERSB */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", false, 1480000000, OMAP4430_VDD_MPU_OPPSUPERSB_UV),
	/* MPU OPP8 - OPP-SUPERSB2 */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", false, 1520000000, OMAP4430_VDD_MPU_OPPSUPERSB2_UV),
#else
	/* MPU OPP5 - OPP-SB */
